...
- **Extension entry point** — registers `mem0_memory` tool, 13 slash commands, and auto-capture hooks
...
- **14 skills** — remember, forget, search, tour, dream, pin, status, stats, review, export, import, projects, switch-project, context-loader
...
| `/mem0-stats` | Memory dashboard by category and age |
| `/mem0-review` | Read-only quality audit |
| `/mem0-export` | Export memories to markdown |
| `/mem0-import` | Import memories from file or text |
| `/mem0-projects` | List projects with memory counts |
| `/mem0-switch` | Override auto-detected project scope |
