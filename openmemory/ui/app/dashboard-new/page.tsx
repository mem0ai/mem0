...
const availableApps: AvailableApp[] = [
  ...
  { id: 'cursor', name: 'Cursor', description: 'Connect via MCP configuration file', priority: 10, category: 'Development', trustScore: 98 },
  { id: 'vscode', name: 'VS Code', description: 'Connect via MCP (Preview)', priority: 9, category: 'Development', trustScore: 98 },
  { id: 'substack', name: 'Substack', description: 'For writers for substack', priority: 8, category: 'Content', trustScore: 95 },
