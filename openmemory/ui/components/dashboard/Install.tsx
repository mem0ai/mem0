...
const clientTabs = [
  ...
  { key: "kilo-code", label: "Kilo Code", icon: "/images/kilo-code.png" },
];
...
const colorGradientMap: { [key: string]: string } = {
  ...
  "kilo-code":
    "data-[state=active]:bg-[linear-gradient(to_top,_rgba(234,221,41,0.3),_rgba(234,221,41,0))] data-[state=active]:border-[#EADD29]",
};
  ...
  return (
    <div>
      ...
      <div className="hidden">
        ...
        <div className="data-[state=active]:bg-[linear-gradient(to_top,_rgba(234,221,41,0.3),_rgba(234,221,41,0))] data-[state=active]:border-[#EADD29]"></div>
      </div>
