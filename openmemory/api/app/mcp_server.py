...
if os.getenv("LLM_PROVIDER") == "anthropic" and not os.getenv("LLM_API_KEY"):
    raise Exception("LLM_API_KEY is not set in .env file")
elif os.getenv("LLM_PROVIDER") == "openai" and not os.getenv("OPENAI_API_KEY"):
