...
CREATE INDEX IF NOT EXISTS ix_apps_created_at ON apps(created_at);
CREATE INDEX IF NOT EXISTS ix_apps_is_active ON apps(is_active);
CREATE INDEX IF NOT EXISTS ix_apps_name ON apps(name);  
CREATE INDEX IF NOT EXISTS ix_apps_owner_id ON apps(owner_id);
-- Add unique constraint for owner_id + app_name combination
CREATE UNIQUE INDEX IF NOT EXISTS unique_owner_app_name ON apps(owner_id, name);
...
CREATE INDEX IF NOT EXISTS idx_documents_user_app ON documents(user_id, app_id);
CREATE INDEX IF NOT EXISTS ix_documents_app_id ON documents(app_id);
...
CREATE INDEX IF NOT EXISTS ix_memories_app_id ON memories(app_id);
CREATE INDEX IF NOT EXISTS ix_memories_archived_at ON memories(archived_at);
...
CREATE INDEX IF NOT EXISTS ix_memories_state ON memories(state);
...
CREATE INDEX IF NOT EXISTS ix_document_memories_document_id ON document_memories(document_id);
CREATE INDEX IF NOT EXISTS ix_document_memories_memory_id ON document_memories(memory_id);
...
CREATE INDEX IF NOT EXISTS ix_memory_categories_category_id ON memory_categories(category_id);
CREATE INDEX IF NOT EXISTS ix_memory_categories_memory_id ON memory_categories(memory_id);
...
CREATE INDEX IF NOT EXISTS ix_access_controls_created_at ON access_controls(created_at);
CREATE INDEX IF NOT EXISTS ix_access_controls_effect ON access_controls(effect);
CREATE INDEX IF NOT EXISTS ix_access_controls_object_id ON access_controls(object_id);
CREATE INDEX IF NOT EXISTS ix_access_controls_object_type ON access_controls(object_type);
CREATE INDEX IF NOT EXISTS ix_access_controls_subject_id ON access_controls(subject_id);
CREATE INDEX IF NOT EXISTS ix_access_controls_subject_type ON access_controls(subject_type);
...
CREATE INDEX IF NOT EXISTS ix_memory_access_logs_access_type ON memory_access_logs(access_type);
CREATE INDEX IF NOT EXISTS ix_memory_access_logs_accessed_at ON memory_access_logs(accessed_at);
CREATE INDEX IF NOT EXISTS ix_memory_access_logs_app_id ON memory_access_logs(app_id);
CREATE INDEX IF NOT EXISTS ix_memory_access_logs_memory_id ON memory_access_logs(memory_id);
...
CREATE INDEX IF NOT EXISTS ix_memory_status_history_changed_at ON memory_status_history(changed_at);
CREATE INDEX IF NOT EXISTS ix_memory_status_history_changed_by ON memory_status_history(changed_by);
CREATE INDEX IF NOT EXISTS ix_memory_status_history_memory_id ON memory_status_history(memory_id);
CREATE INDEX IF NOT EXISTS ix_memory_status_history_new_state ON memory_status_history(new_state);
CREATE INDEX IF NOT EXISTS ix_memory_status_history_old_state ON memory_status_history(old_state);
...
CREATE INDEX IF NOT EXISTS ix_archive_policies_created_at ON archive_policies(created_at);
CREATE INDEX IF NOT EXISTS ix_archive_policies_criteria_id ON archive_policies(criteria_id);
CREATE INDEX IF NOT EXISTS ix_archive_policies_criteria_type ON archive_policies(criteria_type);
