...
from mem0.reranker.aws_bedrock import AWSBedrockReranker
...
class TestAWSBedrockReranker:
    ...
    def sample_config(self):
        ...
        return {"model": "cohere.rerank-v3-5:0", "region": "us-west-2", "top_k": 3}
    ...
    @patch("boto3.client")
    def test_rerank_with_top_k_override(self, mock_boto_client, sample_config, mock_bedrock_client, sample_documents):
        """Test reranking with custom top_k parameter."""
        mock_boto_client.return_value = mock_bedrock_client
        ...
        # Verify request body has correct top_k
        call_args = mock_bedrock_client.invoke_model.call_args
        request_body = json.loads(call_args[1]["body"])
    ...
    def test_rerank_bedrock_error(self, mock_boto_client, sample_config, mock_bedrock_client, sample_documents):
        ...
        mock_bedrock_client.invoke_model.side_effect = ClientError(
            {"Error": {"Code": "ValidationException", "Message": "Invalid model"}}, "invoke_model"
        )
