...
class TestChromaDbHostsInit(unittest.TestCase):
    ...
    def test_init_with_host_and_port(self, mock_client):
        ...
        config = AppConfig(host=host, port=port, anonymous_telemetry=False)
...
class TestChromaDbHostsNone(unittest.TestCase):
    ...
    def test_init_with_host_and_port(self, mock_client):
        ...
        _app = App(config=AppConfig(anonymous_telemetry=False))
...
class TestChromaDbDuplicateHandling:
    def test_duplicates_throw_warning(self, caplog):
        ...
        app = App(config=AppConfig(anonymous_telemetry=False))
...
class TestChromaDbCollection(unittest.TestCase):
    ...
    def test_init_with_custom_collection(self):
        ...
        """
        config = AppConfig(collection_name="test_collection", anonymous_telemetry=False)
        app = App(config)
    ...
    def test_parallel_collections(self):
        ...
        # Create two apps
        app1 = App(AppConfig(collection_name="test_collection_1", anonymous_telemetry=False))
        app2 = App(AppConfig(collection_name="test_collection_2", anonymous_telemetry=False))
    ...
    def test_ids_share_collections(self):
        ...
        # Create two apps
        app1 = App(AppConfig(collection_name="one_collection", id="new_app_id_1", anonymous_telemetry=False))
        app2 = App(AppConfig(collection_name="one_collection", id="new_app_id_2", anonymous_telemetry=False))
    ...
    def test_reset(self):
        ...
        app1 = App(AppConfig(collection_name="one_collection", id="new_app_id_1", anonymous_telemetry=False))
        app2 = App(AppConfig(collection_name="one_collection", id="new_app_id_2", anonymous_telemetry=False))
        app3 = App(AppConfig(collection_name="three_collection", id="new_app_id_1", anonymous_telemetry=False))
        app4 = App(AppConfig(collection_name="four_collection", id="new_app_id_4", anonymous_telemetry=False))
        ...
        app1 = App(AppConfig(collection_name="one_collection", id="new_app_id_1", anonymous_telemetry=False))
        app2 = App(AppConfig(collection_name="one_collection", id="new_app_id_2", anonymous_telemetry=False))
        app3 = App(AppConfig(collection_name="three_collection", id="new_app_id_3", anonymous_telemetry=False))
        app4 = App(AppConfig(collection_name="four_collection", id="new_app_id_3", anonymous_telemetry=False))
