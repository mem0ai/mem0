...
class TestMemoryClient:
    ...
    def test_reset_client(self, mock_client, mocker):
        ...
        mocker.patch.object(MemoryClient, "_validate_api_key", return_value="test@example.com")
        client = MemoryClient(api_key="test_key", client=mock_client)
        mocker.patch.object(client, "delete_users", return_value={"message": "All users deleted"})
    ...
    def test_project_operations(self, mock_client, mocker):
        ...
        mock_client.get.assert_called_once_with(
            ...
            params={
                "fields": ["name", "custom_instructions"],
                "org_id": "org123",
                "project_id": "proj456"
            }
        )
...
class TestAsyncMemoryClient:
    ...
    async def test_async_batch_operations(self, mock_async_client, mocker):
        ...
        mock_async_client.put.return_value = httpx.Response(200, json={"status": "updated"}, request=request)
        memories = [{"memory_id": "mem1", "text": "text1"}]
