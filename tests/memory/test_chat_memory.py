...
def test_add_chat_memory(chat_memory_instance):
    ...
    assert chat_memory_instance.count_chat_memory_entries(app_id) == 1
...
def test_get_recent_memories(chat_memory_instance):
    ...
    recent_memories = chat_memory_instance.get_recent_memories(app_id, n_memories=5)
...
def test_delete_chat_history(chat_memory_instance):
    ...
    assert chat_memory_instance.count_chat_memory_entries(app_id) == 0
