...
class TestElasticsearchDB(unittest.TestCase):
    ...
    def test_custom_search_query(self):
        ...
        filters = None
        query_dict = None
        self.es_db.search(query=query_vector, limit=limit, filters=filters, query_dict=query_dict)

        # Verify custom search query function was called
        self.es_db.custom_search_query.assert_called_once_with(query_vector, limit, filters, query_dict)
