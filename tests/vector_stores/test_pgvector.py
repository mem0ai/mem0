...
class TestPGVector(unittest.TestCase):
    ...
    def test_insert_psycopg3(self, mock_get_cursor, mock_connection_pool):
        ...
        insert_calls = [
            call for call in self.mock_cursor.executemany.call_args_list if "INSERT INTO test_collection" in str(call)
        ]
    ...
    def test_delete_psycopg3(self, mock_get_cursor, mock_connection_pool):
        ...
        delete_calls = [
            call for call in self.mock_cursor.execute.call_args_list if "DELETE FROM test_collection" in str(call)
        ]
    ...
    def test_update_psycopg3(self, mock_get_cursor, mock_connection_pool):
        ...
        update_calls = [
            call for call in self.mock_cursor.execute.call_args_list if "UPDATE test_collection" in str(call)
        ]
    ...
    def test_update_both_vector_and_payload_psycopg3(self, mock_get_cursor, mock_connection_pool):
        ...
        vector_update_calls = [
            call for call in self.mock_cursor.execute.call_args_list if "UPDATE test_collection SET vector" in str(call)
        ]
        payload_update_calls = [
            call
            for call in self.mock_cursor.execute.call_args_list
