...
class TestOpenSearchDB(unittest.TestCase):
    ...
    def setUpClass(cls):
        dotenv.load_dotenv()
        cls.original_env = {
            "OS_URL": os.getenv("OS_URL", "http://localhost:30070"),
    ...
    def setUp(self):
        ...
        patcher = patch("mem0.vector_stores.lindorm_search.OpenSearch", return_value=self.client_mock)
        self.mock_os = patcher.start()
        self.addCleanup(patcher.stop)

        self.os_db = LindormSearch(
