...
class TestWeaviateDB(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Patch Weaviate client before creating an instance
    ...
    def test_get(self):
        ...
        mock_response.uuid = valid_uuid  # Ensure UUID is a string
        ...
        # Exclude 'id' when comparing payloads
        expected_payload = mock_response.properties.copy()  # Make a copy to avoid modifying the original
        expected_payload["id"] = valid_uuid  # Add the ID field manually

        assert result.payload == expected_payload  # Compare adjusted payload


    def test_get_not_found(self):
    # Mock HTTP response for exception
        mock_response = httpx.Response(status_code=404, json={"error": "Not found"})

        # Mock get raising exception with a valid response
    ...
    def test_search(self):
        # Mock search response with objects in the format expected by your implementation
        mock_objects = [
            {
                "uuid": "id1",
        ...
        # Create a mock response object that matches what hybrid() returns
        mock_response = MagicMock()
        mock_response.objects = []
        
        # Add a mock object with the properties your implementation expects
        ...
        # Set up the mock chain for hybrid search
        ...
        self.assertEqual(results[0].score, 0.8)  # Score is 1 - distance
    ...
    def test_list(self):
        # Create mock objects that match the structure expected by your implementation
        mock_objects = []
        ...
        # Create a mock response object with the objects
        mock_response = MagicMock()
        mock_response.objects = mock_objects
        
        # Mock the fetch_objects method
