...
<Note>
  The `output_format` parameter has been removed from the Python and TypeScript SDKs -- responses always use the `v1.1` format. This parameter only applies when calling the REST API directly.
</Note>
