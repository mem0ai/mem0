...
Sidekick is exclusive to the [Claude Code plugin](/integrations/claude-code#sidekick-agent). The other coding-agent plugins provide memory without bundling Sidekick, including the portable Agent Plugins v1 package.
