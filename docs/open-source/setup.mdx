...
description: "Deploy the self-hosted Mem0 REST server and dashboard bundle in minutes with Docker, an admin account, API key management, and a built-in audit log."
icon: "rocket-launch"
---
