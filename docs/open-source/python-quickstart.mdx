...
| `custom_procedural_memory_prompt` | Custom prompt for procedural memory summarization | None |
</Accordion>
...
config = {
    ...
    "custom_procedural_memory_prompt": "Optional custom prompt for procedural memory summarization"
}
```
</Accordion>
</AccordionGroup>
