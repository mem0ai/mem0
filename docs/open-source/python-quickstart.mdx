...
<Accordion title="History Database Configuration">
| Parameter | Description | Default |
|-----------|-------------|---------|
| `type`    | History database type ("sqlite", "postgresql", "mysql") | "sqlite" |
| `url`     | Connection URL or file path for the history database | "{mem0_dir}/history.db" |
</Accordion>
...
config = {
    ...
    "history_db": {"type": "sqlite", "url": "{mem0_dir}/history.db"},
    "version": "v1.1",
