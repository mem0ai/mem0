...
<Callout type="info" title="Why OpenAI API key?">
Mem0 uses OpenAI's models by default for fact extraction and embeddings. The `Memory()` class automatically configures:
- OpenAI `gpt-4.1-nano-2025-04-14` for fact extraction and updates
- OpenAI `text-embedding-3-small` for embeddings

You can use other providers like Ollama, Anthropic, or local models. See [Configuration](/open-source/configuration) to customize your setup.
</Callout>
