...
description: "Configure Mem0 Open Source in Python or TypeScript with your own LLM, embedder, vector store, reranker, and graph memory using a single config object."
icon: "sliders"
---
