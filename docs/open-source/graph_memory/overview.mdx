...
***Note***: The Neptune Analytics instance must be created using the same vector dimension as the vectors the embedding model creates. See: https://docs.aws.amazon.com/neptune-analytics/latest/userguide/vector-index.html
