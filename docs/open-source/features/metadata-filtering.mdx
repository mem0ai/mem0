...
description: Run fine-grained metadata queries against Mem0 Open Source memories using comparisons, logical operators, and wildcards for precise agent retrieval.
icon: "filter"
---
