...
description: Tailor Mem0 Open Source fact extraction with a self-hosted custom prompt and examples so the library stores only the conversation details you care about.
