---
title: "Overview"
description: "Explore Mem0 Open Source features like async memory, multimodal inputs, rerankers, and metadata filters that adapt self-hosted memory for production."
icon: "list"
---
