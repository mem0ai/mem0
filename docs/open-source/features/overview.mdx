...
<CardGroup cols={3}>
  ...
  <Card title="Local Model Compatibility" icon="server" href="/open-source/features/local-model-compatibility">
    Choose the right local runtime and understand tradeoffs across Ollama, LM Studio, and vLLM.
  </Card>
</CardGroup>
