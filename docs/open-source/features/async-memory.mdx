---
title: Async Memory
description: Use AsyncMemory to add, search, update, and delete Mem0 OSS memories without blocking the event loop in FastAPI services, workers, or asyncio code.
icon: "bolt"
---
