...
description: Drop Mem0 into existing OpenAI chat-completion code using the same client interface, adding persistent memory across calls without changing requests.
icon: "message-bot"
---
