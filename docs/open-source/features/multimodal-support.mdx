...
description: Extract searchable facts from images and text with self-hosted Mem0 so agents can recall receipts, screenshots, and product photos shared by users.
icon: "image"
---
