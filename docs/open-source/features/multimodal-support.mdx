...
description: "Add images alongside text with Mem0 open source: extract facts from screenshots, receipts, or photos via URL or base64 in Python and JavaScript SDKs."
icon: "image"
---
