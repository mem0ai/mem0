...
description: Run the FastAPI-powered Mem0 Open Source REST server to add, search, update, and delete memories over HTTP from any language or service in your stack.
icon: "code"
---
