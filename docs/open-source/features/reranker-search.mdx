...
description: Add a reranker pass on top of Mem0 vector search to reorder candidate memories with cross-encoder models and surface the most relevant context first.
icon: "ranking-star"
---
