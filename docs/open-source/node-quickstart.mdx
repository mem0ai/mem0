...
description: "Install the Mem0 Node SDK, initialize the client with an OpenAI key, then add and search your first memory from a TypeScript or JavaScript app in minutes."
icon: "js"
---
