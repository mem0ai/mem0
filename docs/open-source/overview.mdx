---
title: "Overview"
description: "Self-host Mem0 as a Python or Node library or as a REST server, keeping full control over infrastructure, models, and memory data on your own stack."
icon: "house"
---
