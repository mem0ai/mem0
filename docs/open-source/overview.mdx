...
<CardGroup cols={3}>
  <Card title="Self-hosted setup" icon="rocket-launch" href="/open-source/setup">
    Server + dashboard in one stack. Wizard-driven admin setup and API keys.
  </Card>
...
<CardGroup cols={2}>
  <Card title="Deploy with Docker Compose" icon="server" href="/open-source/setup">
    Reference deployment with server, dashboard, and wizard.
  </Card>
  <Card title="Use the REST API" icon="code" href="/open-source/features/rest-api">
    Endpoint reference, auth modes, and automation flows.
  </Card>
</CardGroup>
