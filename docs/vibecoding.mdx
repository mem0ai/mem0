...
description: "Set up agent skills, starter prompts, and MCP so AI coding assistants like Cursor, Claude Code, and Codex build with Mem0 correctly."
...
Get your API key from <a href="https://app.mem0.ai?utm_source=oss&utm_medium=vibecoding">app.mem0.ai</a>, then add Mem0 MCP with a single command:
