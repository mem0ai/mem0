---
title: Hermes Agent
description: "Add long-term memory to Hermes agents with Mem0 via managed Platform, self-hosted server, or fully local OSS, with turn recall and fact extraction."
---
