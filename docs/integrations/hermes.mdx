---
title: Hermes Agent
description: "Add long-term memory to Nous Research's Hermes agent CLI with Mem0 in Platform, self-hosted server, or OSS mode plus background fact extraction."
---
