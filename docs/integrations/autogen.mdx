---
title: AutoGen
description: "Build conversational AI agents with AutoGen and Mem0 to create memory-enabled chatbots that recall past interactions for personalized customer service."
---
...
<Note>Remember to get the Mem0 API key from <a href="https://app.mem0.ai?utm_source=oss&utm_medium=integration-autogen">Mem0 Platform</a>.</Note>
