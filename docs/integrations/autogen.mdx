...
<Note>Remember to get the Mem0 API key from [Mem0 Platform](https://mem0.dev/pd).</Note>
...
MEM0_API_KEY = 'your-mem0-key'  # Replace with your actual Mem0 API key from https://mem0.dev/pd
