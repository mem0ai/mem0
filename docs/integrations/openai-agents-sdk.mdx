...
description: "Integrate Mem0 with the OpenAI Agents SDK for persistent memory across multi-agent workflows, adding context retention and personalization to your agents."
---
...
2. Valid API keys:
   - <a href="https://app.mem0.ai/dashboard/api-keys?utm_source=oss&utm_medium=integration-openai-agents-sdk">Mem0 API Key</a>
