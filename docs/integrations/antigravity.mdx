---
title: Antigravity
description: "Add persistent memory to Google Antigravity with the Mem0 plugin, featuring an MCP server, lifecycle hooks, and slash commands for the agy CLI and IDE."
---
