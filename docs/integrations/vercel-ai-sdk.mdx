---
title: Vercel AI SDK
description: "Use the Mem0 AI SDK Provider with Vercel AI SDK to add persistent memory to conversational AI applications for context-aware responses and personalization."
---
...
1. Get your **Mem0 API Key** from the <a href="https://app.mem0.ai/dashboard/api-keys?utm_source=oss&utm_medium=integration-vercel-ai-sdk">Mem0 Dashboard</a>.
