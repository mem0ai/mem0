...
description: 'Use Mem0 LangChain tools to let AI agents store, search, and manage memories through structured interfaces for context-aware retrieval and personalization'
---
