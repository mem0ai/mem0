---
title: 'Pipecat'
description: 'Integrate Mem0 with Pipecat for long-term conversational memory in voice and chat AI agents, delivering personalized responses based on user history'
---
