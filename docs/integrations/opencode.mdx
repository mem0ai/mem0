---
title: OpenCode
description: "Add persistent memory to OpenCode with the Mem0 plugin featuring native SDK-backed memory tools, lifecycle hooks, and skills that recall project context."
---
