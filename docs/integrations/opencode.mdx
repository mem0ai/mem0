...
This installs the plugin with MCP server, lifecycle hooks, and all `/mem0:` slash commands. Restart OpenCode to activate.

### Option B — MCP Only

If you only need the memory tools without hooks or skills, use OpenCode's built-in MCP configurator:
