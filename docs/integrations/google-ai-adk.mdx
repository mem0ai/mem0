---
title: Google ADK
description: "Integrate Mem0 with Google Agent Development Kit (ADK) for persistent memory across multi-agent workflows, boosting context retention and personalization."
---
...
Set up your API keys:
   - <a href="https://app.mem0.ai/dashboard/api-keys?utm_source=oss&utm_medium=integration-google-ai-adk">Mem0 API Key</a>
   - Google AI Studio API Key

<Note>Remember to get your API key from <a href="https://app.mem0.ai">Mem0 Platform</a> and set up a [Google AI Studio API Key](https://aistudio.google.com/apikey).</Note>
