---
title: Mastra
description: "Use Mastra agents with Mem0 as the memory backend through custom tools for cross-conversation storage, retrieval, and personalized agent responses."
---
...
<Note>Remember to get the Mem0 API key from <a href="https://app.mem0.ai?utm_source=oss&utm_medium=integration-mastra">Mem0 Platform</a>.</Note>
