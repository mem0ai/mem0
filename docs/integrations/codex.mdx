---
title: Codex
description: "Add persistent memory to OpenAI Codex with the Mem0 plugin featuring an MCP server, lifecycle hooks, and SDK skill so Codex remembers tasks and context."
---
