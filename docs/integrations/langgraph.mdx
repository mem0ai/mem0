---
title: LangGraph
description: "Build customer support agents using LangGraph for stateful conversation flow and Mem0 for long-term memory to deliver personalized responses."
---
...
<Note>Remember to get the Mem0 API key from <a href="https://app.mem0.ai?utm_source=oss&utm_medium=integration-langgraph">Mem0 Platform</a>.</Note>
