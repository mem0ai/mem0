---
title: Camel AI
description: "Plug Mem0 cloud memory into Camel AI agents using the built-in Mem0Storage backend to persist and recall conversation context across multi-agent sessions."
