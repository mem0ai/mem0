---
title: AgentOps
description: "Monitor Mem0 memory operations with AgentOps to get automatic tracking, analytics dashboards, and real-time insights into AI agent performance."
---
...
2. Valid API keys:
   - [AgentOps API Key](https://app.agentops.ai/projects)
   - OpenAI API Key (for LLM operations)
   - <a href="https://app.mem0.ai/dashboard/api-keys?utm_source=oss&utm_medium=integration-agentops">Mem0 API Key</a> (optional, for cloud operations)
