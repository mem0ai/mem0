---
title: AWS Bedrock
description: "Use Mem0 with AWS Bedrock and Amazon OpenSearch Service to enable cloud-native semantic memory storage, embeddings, and LLM calls for intelligent agents."
---
