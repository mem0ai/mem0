---
title: Pi Agent
description: "Add persistent memory to Pi Agent with the Mem0 plugin featuring semantic search, automatic capture, and dream consolidation for smarter agent recall."
---
