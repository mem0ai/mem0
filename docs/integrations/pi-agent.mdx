...
5. **8 skills + 8 commands** — Essential memory management from slash commands and agent-guided workflows
...
| `/mem0-scope <scope>` | Change default scope for this session (project, session, user, global) |
...
- **Wrong project detected** — The plugin uses the working directory name as `app_id`. Run Pi from the correct project directory to change scope
