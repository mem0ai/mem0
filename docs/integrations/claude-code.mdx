...
Sidekick is exclusive to the Claude Code plugin. Its agent definition and dedicated hooks live in this package; other Mem0 plugins provide memory without bundling Sidekick.
