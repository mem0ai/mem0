---
title: Claude Code
description: "Add persistent memory to Claude Code CLI and Claude Cowork desktop app with the Mem0 plugin: MCP server, lifecycle hooks, and an SDK skill for recall."
---
