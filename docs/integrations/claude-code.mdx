...
| `top_k` | `3` | Maximum memories returned when Claude runs another search after the automatic first search (1–20). |
| `max_context_chars` | `4000` | Maximum memory characters returned for one search (1,000–10,000). |

## Upgrading from 0.2.x

This is a breaking major update to the Claude Code plugin. It replaces the 0.2.x architecture and command set, but your existing memories and configuration are not lost:
