...
description: "Store and retrieve memories from Raycast with the Mem0 extension for intelligent memory management, quick capture, and semantic search on your Mac."
---
...
a. Sign up at <a href="https://app.mem0.ai?utm_source=oss&utm_medium=integration-raycast">app.mem0.ai</a>
