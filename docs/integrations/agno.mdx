---
title: Agno
description: "Add persistent multimodal memory to Agno agents with Mem0 to store text and image interactions, personalize responses, and keep context across chats."
---
...
2. Valid API keys:
   - <a href="https://app.mem0.ai/dashboard/api-keys?utm_source=oss&utm_medium=integration-agno">Mem0 API Key</a>
