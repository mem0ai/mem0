---
title: Cursor
description: "Add persistent memory to Cursor with the Mem0 MCP server so your AI coding assistant remembers project context, decisions, and preferences across sessions."
---
