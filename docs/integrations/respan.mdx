---
title: Respan
description: "Combine Mem0 persistent memory with Respan LLM observability to build tracked, cost-optimized AI applications with performance metrics and personalization."
---
...
<Note>
You can get your Mem0 API key from the <a href="https://app.mem0.ai/?utm_source=oss&utm_medium=integration-respan">Mem0 dashboard</a>.
</Note>
