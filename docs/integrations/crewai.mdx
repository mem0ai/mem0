---
title: CrewAI
description: "Combine CrewAI multi-agent orchestration with Mem0 for persistent memory across agent interactions, enabling personalized task execution and user history."
---
...
<Note>Remember to get your API keys from <a href="https://app.mem0.ai?utm_source=oss&utm_medium=integration-crewai">Mem0 Platform</a>, [OpenAI](https://platform.openai.com) and [Serper Dev](https://serper.dev) for search capabilities.</Note>
