---
title: OpenClaw
description: "Add long-term memory to OpenClaw agents using the Mem0 plugin with skills-based memory extraction, automatic capture, and semantic recall across sessions."
---
