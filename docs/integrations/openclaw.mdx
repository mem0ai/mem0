...
OpenClaw installs the plugin, prompts you for your email, and connects your Mem0 account via a 6-digit code. See [Chat Setup](#option-1-chat-setup-recommended) below for the full walkthrough.

---

If you prefer the OpenClaw CLI, or are setting up self-hosted / open-source mode, the options below cover both:
...
- **Manual config** — edit `openclaw.json` directly. Useful for CI, scripted deploys, or multi-tenant setups.
...
<Note>Get your API key from <a href="https://app.mem0.ai?utm_source=mem0-docs" rel="nofollow">app.mem0.ai</a>.</Note>
