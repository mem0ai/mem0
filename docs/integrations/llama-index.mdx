---
title: LlamaIndex
description: "Use Mem0 as a memory store in LlamaIndex with support for ReAct and FunctionCalling agent types to add persistent recall and personalized context."
---
...
<Note type="info">
  You can obtain your Mem0 Platform API key from the <a href="https://app.mem0.ai/login?utm_source=oss&utm_medium=integration-llama-index">Mem0 Platform</a>.
</Note>
