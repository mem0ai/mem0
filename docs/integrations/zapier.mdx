---
title: Zapier
description: "Add, search, and manage Mem0 memories from any Zap using the Mem0 Zapier app to bring persistent memory to workflows across thousands of apps, no code."
---
...
1. A Mem0 API key from the <a href="https://app.mem0.ai/dashboard/api-keys?utm_source=oss&utm_medium=integration-zapier">API Keys dashboard</a> (sign up at <a href="https://app.mem0.ai?utm_source=oss&utm_medium=integration-zapier">app.mem0.ai</a> if you do not have an account).
...
- **The connection fails when you paste the key**: check that it starts with `m0-` and has not been revoked in the <a href="https://app.mem0.ai/dashboard/api-keys?utm_source=oss&utm_medium=integration-zapier">API Keys dashboard</a>.
