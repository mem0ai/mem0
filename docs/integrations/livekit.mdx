---
title: Livekit
description: "Build memory-enabled voice assistants with LiveKit, Deepgram, OpenAI, and Mem0 for context-aware voice conversations and intelligent real-time agents."
---
