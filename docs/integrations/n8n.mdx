---
title: n8n
description: "Add long-term memory to n8n workflows and AI Agents with the Mem0 community node to store, search, and recall durable facts across runs, no code required."
---
