...
* First make sure that you have a LangSmith account created and have all the necessary variables handy. LangSmith has [Good Documentation](https://docs.smith.langchain.com/) on how to get started with their service.
...
# Add the URL of the Wikipedia page about Elon Musk.
app.add("https://en.wikipedia.org/wiki/Elon_Musk")

# Query the application with a question.
