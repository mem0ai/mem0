...
<Steps>
  <Step title="Platform → Open Source">
    Export your memories using the Memory Export feature, then import into your self-hosted instance.

    [Learn about memory export →](/platform/features/memory-export)
  </Step>

  <Step title="Open Source → Platform">
    Use our migration scripts to bulk upload your existing memories to the Platform.

    [Contact support for migration help](mailto:support@mem0.ai)
  </Step>
</Steps>
...
<Note>
**Most users start with Platform** for rapid prototyping, then move to Open Source if they need specific infrastructure requirements. Both options support the same core memory operations and framework integrations.
</Note>
