---
title: Quickstart
description: "Create a Mem0 Platform account, grab your API key, install the Python or Node SDK, and store and search your first memory in under five minutes."
icon: "bolt"
iconType: "solid"
---
