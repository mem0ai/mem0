...
description: Query Mem0 memories with the v2 filter syntax to combine users, agents, categories, and time ranges using logical operators for precise retrieval.
---
