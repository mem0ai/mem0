---
title: Direct Import
description: 'Skip the memory inference step and store pre-defined memories directly using the infer parameter for fast bulk ingestion and predictable retrieval.'
---
