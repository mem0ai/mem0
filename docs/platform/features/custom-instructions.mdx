...
description: 'Guide Mem0 Platform memory extraction with natural language project-level instructions that decide what conversation details to store or ignore.'
---
