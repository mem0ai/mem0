...
- **Universal compatibility**: Works with any MCP-compatible client (Claude, Claude Code, Codex, Cursor, Windsurf, VS Code, OpenCode)
...
npx mcp-add \
  ...
  --clients "claude,claude code,codex,cursor,windsurf,vscode,opencode"
```
