---
title: Memory Decay
description: "Boost recently accessed memories and gently dampen stale ones at search time with Mem0 memory decay, keeping every memory available for future queries."
---
