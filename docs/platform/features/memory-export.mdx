---
title: Memory Export
description: 'Export Mem0 memories into structured JSON using customizable Pydantic schemas, with filters to narrow exports by user, agent, session, or metadata.'
---
