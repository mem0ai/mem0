---
title: Group Chat
description: 'Store multi-participant conversations in Mem0 and attribute each turn to the right user_id or agent_id for team meetings and multi-agent workflows.'
---
