...
<Info icon="check">
`results["results"][0]["memory"]` should show the shellfish restriction. If the list is empty, verify that all four identifiers match exactly and the session hasn't been archived.
</Info>
