...
description: 'Attach custom timestamps to Mem0 memories so you can import historical data, preserve accurate chronological ordering, and query by time ranges.'
---
