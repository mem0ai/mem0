...
Graph Memory works automatically on the Mem0 Platform — no configuration needed. When you add memories, entity extraction and relationship building happen behind the scenes.

### Adding Memories with Graph Memory

When adding new memories, relationships with existing memories are automatically built:
