---
title: Webhooks
description: 'Configure project-level webhooks in Mem0 to receive real-time HTTP notifications when memories are added, updated, or deleted in your workspace.'
---
