...
For non-interactive environments (CI, agent runtimes), set credentials via `mem0 init --api-key m0-xxx --user-id alice` or the `MEM0_API_KEY` environment variable.
