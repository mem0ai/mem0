---
title: CLI
description: "Use the mem0 CLI to add, search, list, update, and delete memories directly from your terminal, with npm and Python packages for humans and agents."
icon: "terminal"
iconType: "solid"
---
