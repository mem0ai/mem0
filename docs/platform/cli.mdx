---
title: CLI
description: "Manage memories from your terminal. Available for Python and Node.js."
icon: "terminal"
iconType: "solid"
---

The mem0 CLI lets you add, search, list, update, and delete memories directly from the terminal. It works with the Mem0 Platform API and is available as both a Python package and an npm package.
