...
<CardGroup cols={2}>
  <Card
    ...
    description="Explore advanced MCP configuration and production patterns"
    icon="plug"
    href="/platform/features/mcp-integration"
  />
  <Card
    title="Claude Desktop Cookbook"
    description="Build a memory-aware Claude Desktop assistant with MCP"
    icon="book-open"
    href="/cookbooks/frameworks/claude-desktop-with-mem0-mcp"
  />
</CardGroup>
