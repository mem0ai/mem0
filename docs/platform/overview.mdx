---
title: "Overview"
description: "Mem0 Platform is the fully managed memory layer for AI agents and chat apps, adding personalized long-term context in minutes with no infrastructure."
icon: "cloud"
---
