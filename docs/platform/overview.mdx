...
description: "Mem0 Platform is the managed memory layer for AI agents: persistent user memory, hosted vector store and rerankers, audit logs, and workspace governance."
icon: "cloud"
---
