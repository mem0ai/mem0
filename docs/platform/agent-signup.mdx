...
description: "Let an AI coding agent create its own Mem0 account and API key from the terminal in four commands, with no email signup or dashboard needed."
icon: "robot"
iconType: "solid"
---
