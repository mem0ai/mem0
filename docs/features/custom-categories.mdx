...
response = client.update_instructions_and_categories({"custom_categories": new_categories})
print(response)
```
...
categories = client.get_instructions_and_categories(["custom_categories"])
print(categories)
```
