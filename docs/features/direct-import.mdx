---
title: Direct Memory Storage
description: 'Bypass the memory deduction phase and directly store pre-defined memories for efficient retrieval'
---

## How to use Direct Memory Storage?
The Direct Memory Storage feature allows users to skip the memory deduction phase and directly input pre-defined memories into the system for storage and retrieval.
