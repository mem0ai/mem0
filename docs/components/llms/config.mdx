...
<Tabs>
  <Tab title="Python">
    ...
    | `reasoning_effort`   | Reasoning level (disable, low, medium, high)  | Sarvam, LiteLLM   |
    | `frequency_penalty`  | Penalize frequent tokens (-2.0 to 2.0)        | Sarvam, LiteLLM   |
    | `presence_penalty`   | Penalize existing tokens (-2.0 to 2.0)        | Sarvam, LiteLLM   |
    | `seed`               | Seed for deterministic sampling               | Sarvam, LiteLLM   |
    | `stop`               | Stop sequences (max 4)                        | Sarvam, LiteLLM   |
