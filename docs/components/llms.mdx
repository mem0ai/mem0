...
Install related dependencies using the following command: `pip install --upgrade 'embedchain[cohere]'`.
...
Install related dependencies using the following command: `pip install --upgrade 'embedchain[opensource]'`.
...
Install related dependencies using the following command: `pip install --upgrade 'embedchain[huggingface_hub]'`.
