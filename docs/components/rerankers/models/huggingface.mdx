...
| `normalize` | bool | True | Whether to normalize scores to [0, 1] range |
...
# Or use offline mode by setting the environment variable
# TRANSFORMERS_OFFLINE=1 before running your script
config = {
    "reranker": {
        "provider": "huggingface",
        "config": {
