---
title: Overview
description: "Overview of all supported vector databases in Mem0, including Qdrant, Chroma, PGVector, Oracle AI Database, Pinecone, and more."
---
...
<CardGroup cols={3}>
  ...
  <Card title="Oracle AI Database" href="/components/vectordbs/dbs/oracle"></Card>
