...
config = {
    "vector_store": {
        ...
        "config": {
            ...
            "embedding_model_dims": 1536,  # Matches OpenAI's text-embedding-ada-002
            "serverless_config": {
                "cloud": "aws",  # Choose between 'aws' or 'gcp'
                "region": "us-east-1"
            },
            "metric": "cosine"
        }
...
| `serverless_config` | Configuration for serverless deployment (AWS or GCP) | `None` |
