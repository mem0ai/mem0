...
Here's the parameters available for configuring Mlvus Database:

| Parameter | Description | Default Value |
| --- | --- | --- |
| `url` | Full URL for Milvus/Zilliz server | `http://localhost:19530` |
| `token` | Token for Milvus/Zilliz server | `None` |
