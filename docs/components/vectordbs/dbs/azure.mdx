...
If you prefer to use Azure Identity for authentication instead of an API key, you will need to set the Azure AI Search service to use RBAC:
...
6. **Choose Role:**
    - Mem0 requires the **Search Service Contributor** role.
7. **Choose Member** 
