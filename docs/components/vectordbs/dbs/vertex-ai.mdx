...
description: "Use Google Cloud Vertex AI Vector Search as a managed vector store in Mem0, configuring your project, endpoint, and index for semantic memory search."
---
