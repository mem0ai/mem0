...
Install related dependencies using the following command: `pip install --upgrade 'embedchain[elasticsearch]'`.
...
Install related dependencies using the following command: `pip install --upgrade 'embedchain[opensearch]'`.
...
Install related dependencies using the following command: `pip install --upgrade 'embedchain[milvus]'`.
