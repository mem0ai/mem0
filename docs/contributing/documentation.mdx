---
title: Documentation
description: "Contribute to the Mem0 docs with this guide covering Mintlify setup, Node prerequisites, local preview, and how to submit documentation changes."
icon: "book"
---
