...
<Warning>
**This is legacy documentation for Mem0 v0.x.** For the latest FAQs, please refer to [v1.0 Beta FAQs](/faqs).
</Warning>
...
<Info>
**Ready to upgrade?** Check out our [migration guide](/migration/v0-to-v1) to move to v1.0 Beta and access the latest features!
</Info>