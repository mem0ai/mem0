...
<Warning>
**This is legacy documentation for Mem0 v0.x.** For the latest features, please refer to [v1.0 Beta documentation](/quickstart).
</Warning>
...
<Info>
**Ready to upgrade?** Check out the [migration guide](/migration/v0-to-v1) to move to v1.0 Beta and access new features like reranking and enhanced filtering.
</Info>