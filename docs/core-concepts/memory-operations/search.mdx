---
title: Search Memory
description: Search Mem0 memories with semantic queries, metadata filters, and user or session scopes to pull the most relevant facts for your next prompt.
