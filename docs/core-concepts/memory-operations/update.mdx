---
title: Update Memory
description: Update an existing Mem0 memory by memory_id to fix content, refresh preferences, or enrich metadata without deleting and re-adding the record.
icon: "pen-to-square"
iconType: "solid"
---
