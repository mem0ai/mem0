...
## Next Step: [Search Memory →](/core-concepts/memory-operations/search-memory)

Now that you’ve added memory, learn how to retrieve it with filters, scoring, and semantic relevance.
