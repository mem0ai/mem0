...
|---|---|---|---|---|
| **Overall** | **64%** | 60% | **48%** | 41% |
| preference_following | 88% | 84% | 90% | 79% |
| instruction_following | 85% | 76% | 83% | 59% |
| information_extraction | 70% | 66% | 56% | 49% |
| knowledge_update | 65% | 59% | 75% | 70% |
| multi_session_reasoning | 65% | 63% | 26% | 26% |
| summarization | 64% | 54% | 47% | 24% |
| temporal_reasoning | 62% | 59% | 16% | 23% |
| event_ordering | 54% | 54% | 20% | 7% |
| abstention | 53% | 54% | 40% | 45% |
| contradiction_resolution | 36% | 37% | 33% | 32% |
...
All scores are percentages. All benchmarks run on `gpt-oss-120B`. Scores carry a ±1 point confidence interval due to judge inconsistency.
