...
<Steps>
  <Step title="⚙️ Import app instance">
    ...
    <Accordion title="Customize your app by a simple YAML config" icon="gear-complex">
      ...
      Explore the YAML configurations [here](https://docs.embedchain.ai/advanced/configuration).
      ```python
      from embedchain import Pipeline as App
  ...
  <Step title="🚀 Seamlessly Launch Your Pipeline on the Embedchain Platform!">
    ```python
    app.deploy()
