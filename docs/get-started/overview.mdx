...
<<<<<<< HEAD:docs/get-started/overview.mdx
...
Embedchain enables you to uncover the most pertinent context by performing a semantic search across your data sources based on a given query. Refer to the following example for clarity:
=======
## What is Embedchain?
...
>>>>>>> 603c4b9 (Update docs structure):docs/get-started/introduction.mdx
