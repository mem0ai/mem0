...
description: "Upgrade a self-hosted Mem0 server from the archived ankane/pgvector image to the official pgvector/pgvector:pg17 image with Postgres 17 support."
icon: "arrow-right"
iconType: "solid"
---
