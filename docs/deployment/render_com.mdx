...
- `render.yaml`: Contains render.com specific configuration for deployment (configure this according to your needs)
...
In the `render.yaml` file, update the **repo** key. Put the link of your git repository where your app is located. You can use a repository from [GitHub](https://github.com) or [GitLab](https://gitlab.com/users/sign_in).
