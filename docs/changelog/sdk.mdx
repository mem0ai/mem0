...
<Update label="2026-09-18" description="Agent plugins v0.3.2">

**Improvements:**
- **Telemetry:** `PLUGIN_VERSION` bumped to `0.3.2` across all six Python plugin bundles (Claude Code, Cursor, Codex, Kimi, Antigravity, and the portable package). Telemetry events and the `mem0-plugin/<version>` wire header now reflect the fixes shipped in #7322 through #7358 ([#7373](https://github.com/mem0ai/mem0/pull/7373))
- **Telemetry:** Events are no longer delivered twice, no longer lose parked events on flush, and now attribute each event to the plugin that produced it rather than the one that sent it ([#7323](https://github.com/mem0ai/mem0/pull/7323), [#7324](https://github.com/mem0ai/mem0/pull/7324), [#7325](https://github.com/mem0ai/mem0/pull/7325), [#7358](https://github.com/mem0ai/mem0/pull/7358))
