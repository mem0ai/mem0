...
<Update label="2026-09-02" description="Python v0.2.13 / Node v0.2.14">

**Changes:**
- Coordinated patch release alongside Python SDK v2.0.20 and TypeScript SDK v3.1.8. There are no CLI behavior changes in this release.
