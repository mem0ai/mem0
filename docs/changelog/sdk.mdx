...
Sidekick is now exclusive to Claude Code. Its Sonnet model, worktree isolation, parent-memory handoff, and dedicated lifecycle hooks remain in the Claude Code package.
...
Removes the bundled Sidekick agent and its subagent start/stop hooks. Memory capture, search, and all six skills remain available. Sidekick is exclusive to Claude Code.
...
Keeps native subagent memory handoff and completion tracking under generic subagent names. The package does not bundle Sidekick; that agent is exclusive to Claude Code.
...
Clarifies that the portable package does not bundle Sidekick. Sidekick belongs only to the native Claude Code plugin.
...
Removes the bundled Sidekick agent. Memory capture, search, and all six skills remain available. Sidekick is exclusive to Claude Code.
...
Removes the bundled Sidekick agent and its subagent start/stop hooks. Memory capture, recall, and all six skills remain available. Sidekick is exclusive to Claude Code.
