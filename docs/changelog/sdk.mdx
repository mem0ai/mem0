...
<Note>
  Claude Code, Cursor, Codex, Kimi Code, and Antigravity are version `0.3.0`. This internal refactor does not rename or version-bump the existing npm packages: OpenClaw remains `1.0.16`, OpenCode `0.2.2`, Pi Agent `0.1.5`, and DeepSeek Harness `0.1.1`.
</Note>
