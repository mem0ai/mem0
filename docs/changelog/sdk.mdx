...
**Security:**
- **Dependencies:** Remediate 47 high-severity Dependabot vulnerabilities. Direct upgrades: `axios` → `^1.15.2` in the community package (CVE-2025-27152, CVE-2025-58754, CVE-2026-25639, CVE-2026-42033/35/43/264), `@google/genai` → `^1.40.0` (CVE-2025-66414, CVE-2026-0621, CVE-2026-25536), `@qdrant/js-client-rest` → `^1.18.0` (upgrades transitive `undici` to `^6.24.0`, fixes CVE-2026-1526, CVE-2026-2229). Transitive overrides: `picomatch` → `^2.3.2` (CVE-2026-33671), `jws` → `4.0.1` (CVE-2025-65945), `langsmith` → `^0.6.0` (CVE-2026-45134), `minimatch` across 3.x/5.x/9.x ranges (CVE-2026-27903/04, CVE-2026-26996), `path-to-regexp` → `^8.4.0` (CVE-2026-4926), `rollup` → `^4.59.0` (CVE-2026-27606), `tar-fs` → `^2.1.4` (CVE-2025-48387, CVE-2025-59343), `glob` → `^10.5.0` (CVE-2025-64756) ([#5294](https://github.com/mem0ai/mem0/pull/5294))
