...
<Note>
  Claude Code stays at `0.3.0`. Cursor, Codex, Kimi Code, Antigravity, the portable bundle, OpenCode, Pi Agent, and DeepSeek Harness are aligned at `0.3.0`. OpenClaw moves to `1.1.0` because Dream and pin APIs were intentionally removed.
</Note>
...
<Update label="2026-09-03" description="OpenCode plugin v0.3.0">

**Breaking changes:**
- Removed the obsolete Dream consolidation and pin commands, skills, configuration, and runtime paths.

**Improvements:**
- Reuses the shared TypeScript lifecycle, scoping, formatting, and telemetry implementation while retaining OpenCode's native plugin API.
...
<Update label="2026-09-03" description="openclaw-mem0 v1.1.0">

**Breaking changes:**
- Removed the obsolete Dream consolidation and pin APIs, skills, configuration, and runtime paths.

**Improvements:**
- Reuses the shared TypeScript lifecycle, identity, project-scoping, formatting, and telemetry implementation while retaining OpenClaw's native memory backend and CLI.
...
<Update label="2026-09-03" description="Pi Agent plugin v0.3.0">
...
<Update label="2026-09-03" description="deepseek-plugin v0.3.0">

**New features:**
- Recalls relevant memory during system-prompt assembly and captures completed turns from the durable Harness session stream.

**Improvements:**
- Reuses the shared TypeScript lifecycle, identity, project-scoping, formatting, and telemetry implementation while retaining the native Cordis plugin API.
