...
<Update label="2026-07-08" description="v3.0.13">

**New Features:**
- **Embeddings:** Add `HuggingFaceEmbedder` provider for the TypeScript SDK, backed by the HuggingFace Inference API ([#6027](https://github.com/mem0ai/mem0/pull/6027))
