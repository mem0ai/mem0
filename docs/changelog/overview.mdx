...
<Update label="2025-04-12" description="v2.1.17-beta.1">
**New Features:**
- **Azure OpenAI:** Added support for Azure OpenAI Embedder

**Improvements:**
- **Azure OpenAI:** Updated Azure OpenAI to use new OpenAI SDK
</Update>
