...
- **Current versions:** Claude Code, Cursor, Codex, Kimi Code, and Antigravity are `0.3.0`. The npm packages are OpenClaw `1.0.16`, OpenCode `0.2.2`, Pi Agent `0.2.0`, and DeepSeek Harness `0.1.1`.
