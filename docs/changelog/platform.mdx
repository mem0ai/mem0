...
- **Search:** Added `reference_date` support to anchor relative temporal queries for deterministic tests, backfills, and reproducible demos

**Improvements:**
- **Memory:** Temporal enrichment runs asynchronously by default after v3 writes and feeds retrieval ranking once available
