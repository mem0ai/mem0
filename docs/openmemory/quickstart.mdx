...
## Setting Up Jean Memory

Getting started with Jean Memory is straight forward and takes just a few minutes to set up on your local machine. Follow these steps:
