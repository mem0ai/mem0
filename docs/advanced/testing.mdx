...
'''
{'chunks': ['GETTING RICH IS NOT JUST ABOUT'], 'metadata': [{'source': 'C:\\Users\\Dev\\AppData\\Local\\Temp\\tmp7_cnh810\\tmp.pdf', 'page': 2, 'url': 'https://navalmanack.s3.amazonaws.com/Eric-Jorgenson_The-Almanack-of-Naval-Ravikant_Final.pdf', 'data_type': 'pdf_file'}, 'count': 9940, 'data_type': DataType.PDF_FILE]}

# only one item for readability
'''
```