...
description: Scope Mem0 memories per user, agent, app, or session so a travel service never leaks one traveler's allergies into another customer's booking.
---
