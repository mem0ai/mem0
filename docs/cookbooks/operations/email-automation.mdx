...
description: "Turn your inbox into searchable Mem0 memories that categorize threads, surface past conversations, and generate summaries with an OpenAI Python agent."
---
