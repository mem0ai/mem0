...
description: "Coordinate a multi-user task assistant with Mem0 shared project memories, tracking authored messages, roles, and updates across teammates in Python."
---
