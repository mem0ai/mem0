...
description: "Run a fully local Mem0 companion with Ollama for both the LLM and embedder, keeping user data on your machine with no cloud API calls required."
---
