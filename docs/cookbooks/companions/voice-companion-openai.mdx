...
description: "Combine the OpenAI Agents SDK voice pipeline with Mem0 to build a Python voice assistant that remembers user preferences across spoken sessions."
---
