...
description: "Ship a Node.js fitness coach powered by Mem0 and OpenAI that remembers user goals, workout history, and preferences run after run in JavaScript."
---
