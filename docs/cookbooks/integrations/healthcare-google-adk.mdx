...
description: "Build a Google ADK healthcare coach with Mem0 that remembers symptoms, medical history, and reminders across every patient chat and follow-up session."
---
