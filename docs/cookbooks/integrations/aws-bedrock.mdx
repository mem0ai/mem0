...
description: "Configure the mem0ai Python SDK with AWS Bedrock LLMs and OpenSearch Serverless to run a fully managed, persistent agent memory stack on AWS."
---
