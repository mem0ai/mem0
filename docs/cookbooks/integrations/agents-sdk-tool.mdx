...
description: "Expose Mem0 memory as callable tools inside the OpenAI Agents SDK so Python agents can persist facts and recall them across future conversations."
---
...
- <a href="https://app.mem0.ai/dashboard?utm_source=oss&utm_medium=cookbook-agents-sdk-tool">Mem0 Dashboard</a>
