...
description: "Add long-term Mem0 memory to Mastra agents through tool-use so your TypeScript agents can save and retrieve user facts across every workflow run."
---
