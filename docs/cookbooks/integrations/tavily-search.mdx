...
description: "Blend Tavily realtime web search with Mem0 stored preferences to build a Python search assistant that personalizes results based on past chats."
---
