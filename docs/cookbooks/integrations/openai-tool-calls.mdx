...
description: "Wire Mem0 into OpenAI function-calling so JavaScript agents automatically save and search memories through the native OpenAI tools API using Zod schemas."
---
...
Get your Mem0 API key from the <a href="https://app.mem0.ai/dashboard/api-keys?utm_source=oss&utm_medium=cookbook-openai-tool-calls">Mem0 Dashboard</a>.
...
- <a href="https://app.mem0.ai/dashboard?utm_source=oss&utm_medium=cookbook-openai-tool-calls">Mem0 Dashboard</a>
