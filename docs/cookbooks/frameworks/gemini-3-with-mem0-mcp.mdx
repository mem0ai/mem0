...
```bash
pip install pydantic-ai nest-asyncio python-dotenv uvx google-generativeai
```
...
<Note>
Ensure you have your Mem0 API key from the [Mem0 Dashboard](https://app.mem0.ai) and your Gemini API key from the [Google AI Studio](https://makersuite.google.com/app/apikey).
</Note>
...
**Prompt:**
```
I need medical test data for a healthcare dashboard demo. Generate 5 synthetic patient records with diverse ethnicities, ages, and conditions, then store all of them. Also check if we have any existing patient data in memory.
```

**Response:**
```
I've created and stored 5 synthetic patient records for your healthcare dashboard demo:
- Aisha Patel (65, South Asian) - Type 2 diabetes, last HbA1c: 7.2%, medication: Metformin
- Miguel Rodriguez (42, Hispanic) - Hypertension, BP: 140/90, on ACE inhibitors
- Yuki Tanaka (38, East Asian) - Asthma, uses albuterol inhaler, last ER visit: 6 months ago
- Jamal Williams (55, African American) - Pre-diabetes, fasting glucose: 115 mg/dL
- Lena Andersson (48, Caucasian) - Hyperlipidemia, LDL: 165 mg/dL, on statins

I searched for existing patient data in your memory but found none. All synthetic patient records have been stored with appropriate medical data points for demo purposes.
```
