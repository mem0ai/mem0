...
description: "Connect Google Gemini 3 to the Mem0 cloud MCP server to add memory tools like add_memory and search_memories to any MCP-compatible AI client."
---
