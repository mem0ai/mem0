...
description: "Give ElizaOS characters long-term memory with Mem0 so your agent keeps personality, backstory, and user context across every conversation and restart."
---
