...
description: "Add persistent Mem0 memory to a LlamaIndex ReAct agent so it can reason, call tools, and recall prior interactions across every conversation turn."
---
...
Initialize the Mem0 client. You can find your API key <a href="https://app.mem0.ai/dashboard/api-keys?utm_source=oss&utm_medium=cookbook-llamaindex-react">here</a>. Read about Mem0 [Open Source](https://docs.mem0.ai/open-source/overview).
```python
