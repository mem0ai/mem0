...
class MiroFishSimulation:
    ...
    def quick_search(self, query: str, top_k: int = 10) -> dict:
    ...
    def agent_search(self, agent_id: str, query: str, top_k: int = 10) -> dict:
...
def main():
    ...
    opposition = sim.quick_search("opposition to housing reform", top_k=5)
    ...
    for query in queries:
        print(f"\n  Query: '{query}'")
        results = sim.quick_search(query, top_k=3)
