...
description: "Coordinate LlamaIndex AgentWorkflow tutors and reviewers over one shared Mem0 memory layer so specialized agents collaborate with the same context."
---
...
You can obtain your Mem0 Platform API key from the <a href="https://app.mem0.ai?utm_source=oss&utm_medium=cookbook-llamaindex-multiagent">Mem0 Platform</a>.
...
- <a href="https://app.mem0.ai/?utm_source=oss&utm_medium=cookbook-llamaindex-multiagent">Mem0 Platform</a>
