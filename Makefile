...
install_all:
	...
	poetry run pip install pinecone-text pinecone-client langchain-anthropic "unstructured[local-inference, all-docs]" langchain-together==0.1.3 langchain-cohere==1.16.0
