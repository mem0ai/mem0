...
6. **Test Coverage** — Check what applies:
   - Added/updated unit tests
   - Added/updated integration tests
   - Tested manually (describe how)
   - No tests needed (explain why)
7. **Checklist** — All must be checked before merge:
...
Do not reproduce it here. GitHub prefills it from [`.github/PULL_REQUEST_TEMPLATE.md`](.github/PULL_REQUEST_TEMPLATE.md); read that file if you need the exact wording.
