...
def calculate_metrics(prediction: str, reference: str) -> Dict[str, float]:
    ...
    rouge_scores = 0  # calculate_rouge_scores(prediction, reference)  # noqa: F841
    bleu_scores = calculate_bleu_scores(prediction, reference)
    bert_scores = 0  # calculate_bert_scores(prediction, reference)  # noqa: F841
    meteor = 0  # calculate_meteor_score(prediction, reference)  # noqa: F841
    sbert_similarity = 0  # calculate_sentence_similarity(prediction, reference)  # noqa: F841
