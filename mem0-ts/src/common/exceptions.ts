...
export class GraphStoreError extends MemoryError {
  constructor(
    message: string,
    errorCode: string = "GRAPH_001",
    options: MemoryErrorOptions = {
...
export class DependencyError extends MemoryError {
  constructor(
    message: string,
    errorCode: string = "DEPS_001",
    options: MemoryErrorOptions = {
      suggestion: "Please install the required dependencies",
    },
  ) {
    super(message, errorCode, options);
