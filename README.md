...
Embedchain is an open source conversational AI framework that makes it easy to create and deploy responsible AI apps. At its core, Embedchain follows the design principle of being *"Conventional but Configurable"* to serve both software engineers and machine learning engineers.
