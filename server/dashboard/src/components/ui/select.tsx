...
import { Check, ChevronDown, ChevronLeft, ChevronRight, ChevronsUpDown, ChevronUp } from "lucide-react"
...
const SelectItem = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof SelectPrimitive.Item> & { checkIcon?: React.ReactNode; checkPosition?: 'left' | 'right' }
>(({ className, children, checkIcon, checkPosition = 'left', ...props }, ref) => (
