...
def main():
    ...
    config = {
        ...
        "vector_store": {"provider": "qdrant", "config": {"collection_name": "mem0_example", "path": "./qdrant_db"}},
        "llm": {"provider": "openai", "config": {"model": "gpt-4o-mini", "api_key": os.getenv("OPENAI_API_KEY")}},
        "embedder": {
            "provider": "openai",
