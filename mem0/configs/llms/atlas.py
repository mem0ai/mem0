...
class AtlasConfig(BaseLlmConfig):
    """
    ...
    Atlas Cloud exposes an OpenAI-compatible API, so this provider reuses the
    OpenAI client and only overrides the base URL and default model.
    """
    ...
    def __init__(
        ...
        Args:
            ...
            atlas_base_url: Atlas Cloud API base URL, defaults to None
        """
        ...
        # Atlas Cloud-specific parameters
        self.atlas_base_url = atlas_base_url
