...
class ElasticsearchConfig(BaseModel):
    ...
    custom_search_query: Optional[Callable[[List[float], int, Optional[Dict], Optional[Dict]], Dict]] = Field(
        None,
        description="Custom search query function. Parameters: (query, limit, filters, query_dict) -> Dict"
    )
