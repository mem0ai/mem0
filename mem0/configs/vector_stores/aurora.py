...
class AuroraConfig(BaseModel):
    ...
    hnsw_m: Optional[int] = Field(200, description="HNSW M parameter (connections per node). Defaults to 16.")
    hnsw_ef_construction: Optional[int] = Field(16, description="HNSW ef_construction parameter. Defaults to 200.")
    ...
    max_parallel_maintenance_workers: Optional[int] = Field(4, description="Sets the maximum number of parallel workers that can be started by a single utility command. Defaults to 4.")
