...
class BaseEmbedderConfig(ABC):
    ...
    def __init__(
        ...
        :param openai_base_url: Openai base URL to be use, defaults to None (OpenAIEmbedding then
            falls back through OPENAI_API_BASE, then OPENAI_BASE_URL, then "https://api.openai.com/v1")
