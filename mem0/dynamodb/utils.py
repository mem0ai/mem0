...
def create_dynamodb_tables(region: str, conversation_table_name: str, graph_table_name: str, 
                          ttl_enabled: bool = False, gsi_enabled: bool = True):
    """
...
def generate_cloudformation_template(conversation_table_name: str, graph_table_name: str,
                                    ttl_enabled: bool = False, gsi_enabled: bool = True) -> str:
    """
