    ...
    def _add_to_vector_store(self, messages, metadata, filters, infer, prompt=None):
        ...
        try:
            ...
            for hr in history_records:
                try:
                    self.db.add_history(hr["memory_id"], None, hr["new_memory"], "ADD", created_at=hr.get("created_at"), actor_id=hr.get("actor_id"))
                except Exception as e:
            ...
            for hr in history_records:
                try:
                    await asyncio.to_thread(
                        ...
                        created_at=hr.get("created_at"), actor_id=hr.get("actor_id")
                    )
                except Exception as e:
