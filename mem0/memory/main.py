...
class Memory(MemoryBase):
    ...
    def _update_memory(self, memory_id, data, existing_embeddings, metadata=None):
        ...
        # Start from the full existing payload so no custom metadata is lost.
        # Then apply caller-supplied metadata on top, followed by the system
        # fields that must always reflect the latest update.
