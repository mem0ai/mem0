...
# Vector-store config attribute names that hold the embedding dimension.
# Most stores use ``embedding_model_dims``; databricks uses ``embedding_dimension``.
_VS_DIMS_ATTRS = ("embedding_model_dims", "embedding_dimension")


def _propagate_embedding_dims(embedding_model, vector_store_config):
...
class Memory(MemoryBase):
    def __init__(self, config: MemoryConfig = MemoryConfig()):
        ...
        _propagate_embedding_dims(self.embedding_model, self.config.vector_store.config)
