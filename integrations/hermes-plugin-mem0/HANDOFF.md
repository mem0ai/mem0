...
The original native provider MIT license is retained in `LICENSE`. The plugin-local redaction and batching helper
...
- Carries the plugin changes from [Mem0 PR #7370](https://github.com/mem0ai/mem0/pull/7370)
  at `4284ef0d2a5c28d8a2abc9b1187b664e5c6fc00d` into a standalone subdirectory.
- Owns `_message_utils.py` locally; no shared runtime, generated files, or build registration.
- Uses local secret redaction and token-aware batching for non-empty completed-turn text.
