...
For local development, build and load the generated native bundle:

```bash
python3 integrations/agent-plugins/scripts/build.py claude-code --kind native --output integrations/agent-plugins/dist/claude-code/native
claude --plugin-dir integrations/agent-plugins/dist/claude-code/native
```
...
```bash
python3 -m pytest integrations/agent-plugins/hosts/claude-code/tests -q
python3 -m ruff check integrations/agent-plugins/core/python integrations/agent-plugins/hosts
claude plugin validate --strict integrations/agent-plugins/dist/claude-code/native
```
