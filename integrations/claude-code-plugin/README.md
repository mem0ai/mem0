...
Sidekick is exclusive to this Claude Code plugin. This package owns its agent definition and dedicated hook handlers; the shared core supplies generic memory and subagent tracking only.
