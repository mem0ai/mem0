...
configure_harness("openclaw", data_dir_name="openclaw-plugin", source_tag="openclaw_plugin")
telemetry.init(harness="openclaw", source_tag="OPENCLAW_PLUGIN")
