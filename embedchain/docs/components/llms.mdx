...
<CardGroup cols={4}>
  ...
  <Card title="Nebius AI Studio" href="#nebius"></Card>
...
```bash
pip install --upgrade 'embedchain[nebius]'
```

Set the `NEBIUS_API_KEY` as environment variable which you can find on their [Account settings page](https://studio.nebius.com/?modals=create-api-key).
