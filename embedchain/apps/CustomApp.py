...
class CustomApp(EmbedChain):
    ...
    def __init__(
        ...
        :type llm: BaseLlm
        :param db: The database to use for storing and retrieving embeddings. example: `from embedchain.vectordb.chroma_db import ChromaDb`, defaults to None
        :type db: BaseVectorDB
        :param embedder: The embedder (embedding model and function) use to calculate embeddings. example: `from embedchain.embedder.gpt4all_embedder import GPT4AllEmbedder`, defaults to None
