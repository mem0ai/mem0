...
from embedchain.config import AWSBedrockEmbedderConfig
...
class AWSBedrockEmbedder(BaseEmbedder):
    def __init__(self, config: Optional[AWSBedrockEmbedderConfig] = None):
        ...
        if self.config.model == "amazon.titan-embed-text-v1":
        ...
        self.set_vector_dimension(vector_dimension=vector_dimension or self.config.vector_dimension)
