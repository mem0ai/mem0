...
from embedchain.config.vectordbs import ElasticsearchDBConfig, QdrantDBConfig
...
class BaseAppConfig(BaseConfig):
    ...
    def __init__(
        ...
        :param qdrant_config: Optional. qdrant database config to be used for connection
        """
    ...
    @staticmethod
    def get_db(db, embedding_fn, host, port, db_type, vector_dim, collection_name, es_config, qdrant_config):
        """
        ...
        if db_type == VectorDatabases.QDRANT:
