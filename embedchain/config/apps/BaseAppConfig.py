...
class BaseAppConfig(BaseConfig):
    ...
    def __init__(
        ...
        self.db = BaseAppConfig.get_db(
            db=db, embedding_fn=embedding_fn, host=host, port=port, db_type=db_type, vector_dim=vector_dim
        )
    ...
    @staticmethod
    def get_db(db, embedding_fn, host, port, db_type, vector_dim):
        """
        ...
        if db_type == "es":
            ...
            return VectorDb(EsDB(embedding_fn=embedding_fn, vector_dim=vector_dim), db_type)
